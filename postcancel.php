...
<hr>
<div id="down " style="background-color:transparent; color:black; padding:10px;margin-top:0px;margin-left:327px; width: 600px; height:300px">
	<img src="images\cancelled.jpg" alt="University" style="float:left;width:600px;height:300px;margin-left: 20px;">
